...
export const curtainServiceContent: ServiceTemplateContent = {
  ...
  description:
    "Cortinas de vidrio en Paraguay para balcones, quinchos y frentes. Cerramientos corredizos con apertura práctica, visual limpia y fabricación a medida.",
  canonicalPath: "/servicios/cortina",
  keywords:
    "cortina de vidrio paraguay, cerramiento de balcon, cortinas corredizas de vidrio, quinchos, cristal templado",
  whatsappMessage:
    "Hola, quiero cotizar una cortina de vidrio. Me comunico desde su página web.",
  relatedWorksKey: "cortina",
  hero: {
    eyebrow: "Cortinas de vidrio",
    title: "Cortinas de vidrio para cerrar sin perder visual ni flexibilidad",
    description:
      "Sistemas corredizos de cristal templado para balcones, galerías, quinchos y frentes comerciales. Soluciones a medida para ganar protección sin bloquear luz ni amplitud.",
    image:
  ...
  problem: {
    ...
    cases: [
      ...
      },
      {
        ...
        description: "Soluciones opacas o con demasiada perfilería que rompen la estética del proyecto.",
      },
      {
        title: "Uso poco flexible",
        description: "Necesidad de abrir totalmente el frente cuando el clima acompaña.",
      },
    ],
  },
  solutions: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Cerramiento de vidrio con apertura práctica para locales que necesitan visibilidad, seguridad y una fachada limpia.",
  ...
  selection: {
    ...
    description:
      "Definimos el sistema según apertura requerida, exposición al clima y nivel de uso del espacio.",
    items: [
      {
  ...
  trust: {
    ...
    description:
      "VIPAR S.A. fabrica e instala soluciones en vidrio y aluminio con criterio técnico, respaldo local y seguimiento real del proyecto desde la medición hasta la colocación final.",
